...
class TrainingTab(QWidget):
    ...
    def init_ui(self):
        ...
        blockchain_status.setToolTip("All training completions are securely recorded for audit and transparency.")
        ...
        export_btn.setAccessibleName("Export Training Report Button")
        export_btn.setToolTip("View and export blockchain-based training reports.")
