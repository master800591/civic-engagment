...
class SystemGuideTab(QWidget):
    ...
    def overview_section(self) -> QWidget:
        ...
        blockchain_status.setToolTip("All system guide updates are securely recorded for audit and transparency.")
        ...
        export_btn.setAccessibleName("Export Guide Report Button")
        export_btn.setToolTip("View and export blockchain-based system guide reports.")
