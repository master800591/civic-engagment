...
class MapView(QWidget):
    ...
    blockchain_status.setToolTip("All location saves are securely recorded for audit and transparency.")
    ...
    export_btn.setAccessibleName("Export Location Report Button")
    export_btn.setToolTip("View and export blockchain-based location reports.")
