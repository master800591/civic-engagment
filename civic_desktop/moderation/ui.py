...
class ModerationDashboard(QWidget):
    ...
    def create_users_tab(self):
        ...
        self.warning_reason.setPlaceholderText("Explain the reason for this warning...")
        self.warning_reason.setMaximumHeight(100)
        warn_layout.addWidget(self.warning_reason)
        
        self.warn_btn = QPushButton("Issue Warning")
        self.warn_btn.clicked.connect(self.warn_user)
        warn_layout.addWidget(self.warn_btn)
