...
class ContractSectionWidget(QFrame):
    ...
    def __init__(self, section: ContractSection, parent: Optional[QWidget] = None) -> None:
        ...
        blockchain_status.setToolTip("All contract acceptances are securely recorded for audit and legal purposes.")
        ...
        export_btn.setAccessibleName("Export Contract Report Button")
        export_btn.setToolTip("View and export blockchain-based contract reports.")
